...
import { TextArea, Button, Row, Col, Input, SelectCom } from "component";
...
export default class Home extends Component {
  ...
  addRoom(id) {
    // const url = 'http://192.168.43.43:8080/addroom';

    const url = 'http://125.124.143.31:8888/ssm/addroom';
    let data = {
  ...
  inRoom(val) {
    let url = "http://125.124.143.31:8888/ssm/inroom"
    Axios.get(url, {
      params: {
        roomid: val
      }
      ...
      <div>
        ...
        <div className="m-home">
          ...
          <div className="part part-2">
            ...
            <div className="tip">注：房间ID为创建房间后 生成的9位数字</div>
          </div>
        </div>
      </div>
    );
